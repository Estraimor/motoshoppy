...
<form method="post"
    ...
    <?php if ($edit): ?>
        <input type="hidden" name="idproveedores"
    ...
    <button class="btn btn-primary w-100 mt-2" name="guardar">
...
<div class="col-md-8">
<div class="card shadow-sm">
<div class="card-header fw-bold">Proveedores</div>
...
<tr class="<?= $clase ?>">
    ...
    <td><?= $p['telefono'] ?: '<span class="text-muted">No se agregó</span>' ?></td>
    <td><?= $p['email'] ?: '<span class="text-muted">No se agregó</span>' ?></td>
    <td>
        <?= $p['activo']
