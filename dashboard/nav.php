...
$base = BASE_URL; // ej: '/motoshoppy' en local, '' en producción
...
/* =========================
   CONFIGURACIÓN
========================= */
$is_config_active = str_starts_with($uri, "$base/settings") ||
  str_starts_with($uri, "$base/configuracion");
  ...
  <div class="wrapper">
    ...
    <aside class="sidebar">
      ...
      <nav class="nav-links">
        ...
        <?php if (tieneRol($rolesArray, 'Administrador') || tieneRol($rolesArray, 'Ventas')): ?>
          <a href="<?= BASE_URL ?>/clientes/index.php" class="<?= str_starts_with($uri, "$base/clientes") ? 'active' : '' ?>">
